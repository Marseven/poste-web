...
import 'package:local_delivery_admin/screens/Admin/AgenceScreen.dart';
import 'package:local_delivery_admin/screens/Admin/BagScreen.dart';
import 'package:local_delivery_admin/screens/Admin/CreateBagScreen.dart';
...
List<MenuItemModel> getMenuItems() {
  ...
  list.add(MenuItemModel(
      index: CREATE_BAG_INDEX,
      imagePath: 'assets/icons/ic_create_order.png',
      title: language.createBag,
      route: CreateBagScreen.route));
  list.add(MenuItemModel(
      index: BAG_INDEX,
      imagePath: 'assets/icons/ic_bag.png',
      title: language.bag,
      route: BagScreen.route));
  list.add(MenuItemModel(
  ...
  list.add(MenuItemModel(
      index: AGENCE_INDEX,
      imagePath: 'assets/icons/ic_marker.png',
      title: language.agence,
      route: AgenceScreen.route));
  list.add(MenuItemModel(
      index: VEHICLE_INDEX,
