...
const currencySymbolDefault = 'FCFA';
const currencyCodeDefault = 'XAF';
...
const defaultCurrencySymbol = 'FCFA';
...
const AGENCE_ID = 'Agence';
const AGENCE_DATA = 'AGENCE_DATA';
...
const CITY_INDEX = 2;
const AGENCE_INDEX = 3;
const VEHICLE_INDEX = 4;
const EXTRA_CHARGES_INDEX = 5;
const PARCEL_TYPE_INDEX = 6;
const PAYMENT_GATEWAY_INDEX = 7;
const CREATE_ORDER_INDEX = 8;
const ORDER_INDEX = 9;
const CREATE_BAG_INDEX = 10;
const BAG_INDEX = 11;
const DOCUMENT_INDEX = 12;
const DELIVERY_PERSON_DOCUMENT_INDEX = 13;
const USER_INDEX = 14;
const DELIVERY_PERSON_INDEX = 15;
const APP_SETTING_INDEX = 16;
