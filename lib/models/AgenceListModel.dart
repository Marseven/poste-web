...
class AgenceListModel {
  PaginationModel? pagination;
  List<AgenceData>? data;

  AgenceListModel({this.pagination, this.data});

  AgenceListModel.fromJson(Map<String, dynamic> json) {
    ...
    if (json['data'] != null) {
      data = <AgenceData>[];
      json['data'].forEach((v) {
        data!.add(new AgenceData.fromJson(v));
      });
    }
  }
...
class AgenceData {
  ...
  AgenceData.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    name = json['name'];
