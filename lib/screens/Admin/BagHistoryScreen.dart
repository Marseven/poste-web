...
class BagHistoryComponent extends StatelessWidget {
  final List<OrderHistoryModel> orderHistory;

  BagHistoryComponent({required this.orderHistory});
      ...
      itemBuilder: (context, index) {
        ...
        return TimelineTile(
          ...
          endChild: Padding(
            ...
            child: Row(
              children: [
                ImageIcon(AssetImage(statusTypeIcon(type: mData.history_type)),
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      Text('${mData.history_type!.replaceAll("_", " ")}',
                          style: boldTextStyle()),
                      SizedBox(height: 8),
                      Text(messageData(mData), style: primaryTextStyle()),
                      SizedBox(height: 8),
                      Text('${printDate('${mData.created_at}')}',
